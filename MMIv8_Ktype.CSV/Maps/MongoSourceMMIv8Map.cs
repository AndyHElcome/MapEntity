...
namespace MMIv8_Ktype.CSV.Maps
{
    ...
    public sealed class MongoSourceMMIv8GenericMap : ClassMap<MongoSourceMMIv8Generic<VersionProviderApi>> //TODO COULDNT GET WORKING
    {
        public MongoSourceMMIv8GenericMap(IVersionProvider versionProvider)
        {
            AutoMap(CultureInfo.InvariantCulture);

            Parameter("mmi_V8_Key").Name("MMI V8 Key");
            Parameter("versionProvider").Constant((VersionProviderApi)versionProvider);

...
namespace MMIv8_Ktype.Models.Collections
{
    ...
    public class MatchEntity : ICollectionEntity<ObjectId>, IStatusHistory
    {
        ...
        //[BsonIgnore]
        //public MatchRefine MatchRefine { get; set; }
        public decimal? ScoreSum { get; set; }
        public decimal? ScoreAverage { get; set; }

        //[Obsolete]
        //[BsonIgnore]
        //public bool IsBest => MMIv8Entity.MatchRefine.BestScore is not null && ScoreSum == MMIv8Entity.MatchRefine.BestScore;

        [BsonIgnore]
        public bool IsMMIv8Best => MMIv8Entity.MatchRefine.BestScore is not null && ScoreSum == MMIv8Entity.MatchRefine.BestScore;

        [BsonIgnore]
        public bool IsTecDocPCBest => TecDocEntity.MatchRefine.BestScore is not null && ScoreSum == TecDocEntity.MatchRefine.BestScore;
